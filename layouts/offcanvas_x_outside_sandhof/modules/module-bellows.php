...
<div class="constrainer-maxsize layout-padding-sides abstand-bottom abstand-top">

    <!-- Bellows Group -->
    <section class="bellows" data-bellow-group="groupID">
        ...
        <div class="bellows-element-wrp">
            ...
            <div class="bellows-content" data-bellow-content="<?= $triggerID ?>" data-listener="slider">
    ...
    (function () {
        ...
        selt.modules[moduleName] = {
            ...
            init: function () {
                ...
                document.querySelector('[data-listener="slider"]').addEventListener('bellowsopened', function (e) {
                    console.log(e);
