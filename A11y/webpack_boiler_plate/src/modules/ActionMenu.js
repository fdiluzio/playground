...
var ActionMenu = function (domNode, controllerObj) {
...
ActionMenu.prototype.handleKeydown = function (event) {
  var flag = false,
    char = event.key,
    clickEvent;
...
/* EVENT HANDLERS */
ActionMenu.prototype.handleBlur = function (event) {
  this.close();
};

ActionMenu.prototype.handleMouseover = function (event) {
  this.hasHover = true;
};

ActionMenu.prototype.handleMouseout = function (event) {
  this.hasHover = false;
  setTimeout(this.close.bind(this, false), 300);
};

/* FOCUS MANAGEMENT METHODS */
ActionMenu.prototype.setFocus = function (item) {
...
ActionMenu.prototype.setFocusToFirstItem = function () {
  this.setFocus(this.firstItem);
};

ActionMenu.prototype.setFocusToLastItem = function () {
  this.setFocus(this.lastItem);
};

ActionMenu.prototype.setFocusToPreviousItem = function () {
  var index;
...
ActionMenu.prototype.setFocusToNextItem = function () {
  var index;
...
ActionMenu.prototype.setFocusByFirstCharacter = function (char) {
...
ActionMenu.prototype.getIndexFirstChars = function (startIndex, char) {
...
ActionMenu.prototype.getCurrentItem = function () {
...
ActionMenu.prototype.open = function () {
...
ActionMenu.prototype.close = function (force) {
...
ActionMenu.prototype.setFocusToController = function () {
